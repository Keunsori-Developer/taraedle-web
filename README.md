...
이전까지는 프론트엔드 개발을 하더라도 같은 업무의 팀원과 함께 진행했지만, 이번에는 혼자 웹을 만들어보았습니다.  
프론트엔드 개발 중 막히는 부분이 있더라도 직접 해결해나가야 했던 만큼 개발력을 성장시키는 기회가 되었습니다.  
또한 중간중간 챗gpt를 처음으로 활용해 보았는데, 무조건적인 신뢰로 개발하는 것은 조심해야 하지만 막히는 부분에 대해서 이정표 역할은 해줄 수 있다는 점에서 현재 개발 트랜드가 챗gpt를 활용하는지에 대해 배울 수 있었습니다.